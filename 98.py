...
cards = ['Tiny Froggit', 'Blue Snail', 'Dummy', 'Red Snail', 'Spider', 'Snowman', 'Yellow Snail', 'Froggit', 'Moldsmal', 'Migosp', 'Loox', 'Annoying Dog', 'Bridge Seed', 'Charles', 'Ferry', 'G Follower 1', 'Lamp', 'Monster Kid', 'Temmie', 'Allergic Temmie', 'Big Bob', 'Bomb', 'Cactus', 'Candy Dish', 'Crazy Bun', 'Diamond Boy 1', 'Diamond Boy 2', 'Doggo', 'Echo Flower', 'Fishing Rod', 'Flowey', 'Goner Kid', 'Ice Cap', 'Janitor', 'Mace', 'Memorial Statue', 'Microwave', 'Moldbygg', 'Napstablook', 'Receptionist 3', 'Scarf Mouse', 'Shyren', 'Temmie Statue', 'Timer', 'Trash Tornado', 'Vegetoid', 'Water Cooler', 'Whimsun', 'Blue Laser', 'Chilldrake', 'Clam Boy', 'Coffin', 'Disco Ball', 'Faun', 'Fire Trap', 'Fuku Fire', 'Glad Dummy', 'Golden Flowers', 'Heats Flamesman', 'Ice', 'Librarian', 'Memory Head', 'Mettaton', 'Migospel', 'Moldessa', 'Orange Laser', 'Parsnik', 'Politics Bear', 'Receptionist 2', 'Redacted', 'Small Bird', 'Snow Poff', 'Snowdrake', 'Tree', 'Vulkin', "Vulkin's Cloud", 'Aaron', 'Alphys', 'Asriel', 'Big Mouth', 'Bob', 'Bunbun', 'Dimensional Box', 'Dog Food', 'Dog House', 'Dogamy', 'Dogaressa', 'Echo Fish', 'Garbage', 'Gaster', 'Gift Bear', 'Grillby', 'Igloo', 'Jerry', 'Loren', 'MTT Fountain', 'Madjick', "Muffet's Pet", 'Nacarat Jester', 'Pyrope', 'Red Bird', 'Skateboard Girl', 'So Sorry', 'Trader Temmie', 'Burgerpants', 'G Follower 2', 'Ice Wolf', 'Innkeeper', 'Lemon Bread', 'Lesser Dog', 'Mad Dummy', 'Nice Cream Guy', 'Papyrus Statue', 'Reaper Bird', 'Receptionist 1', 'Rock', 'Sad Customer', 'Sad Dragon', 'Sans', 'Shambling Mass', 'Snail Trainer', 'Ugly Fish', 'Woshua', 'Astigmatism', 'Big Bomb', 'Bratty', 'Catty', 'Clam Girl', 'Dancer Mettaton', 'Everyman', 'Final Froggit', 'Greater Dog', 'Gyftrot', 'Manticore', 'Oni', "Snowdrake's Mom", 'Whimsalot', 'Coffee Man', 'Elder Puzzler', 'Endogeny', 'G Follower 3', 'Gerson', 'River Person', 'Tsunderplane', 'Knight Knight', 'Mettaton NEO', 'Royal Guard 1', 'Royal Guard 2', 'Glyde', 'Mettaton Ex', 'Muffet', 'Onion San', 'Toriel', 'Casual Undyne', 'Papyrus', 'Asgore', 'Frisk', 'Omega Flowey', 'Undyne', 'The Heroine', 'Asriel Dreemurr', 'Angel of Death', 'Chara']
...
spells = ['Break', 'Force of Nature', 'Fridge', 'Protection', 'Acceleration', 'Assault', 'Heal', 'Inflation', 'Investment', 'Penetration', 'Poison', 'Will to Fight', 'Defrosting', 'Pie', 'Strength', 'Cloning', 'Feast', 'Knife', 'Punishment', 'Resurrection', 'Shootout', 'Shopping', 'Slowing', 'Soothing', 'Spider Web', 'Worsening', 'Another Chance', 'Froggit Trio', 'Last Dream', 'Pollutant Gas', 'Strafe', 'Termination', "Aaron's Secret", 'Brain Shift', 'Cold Winter', 'Expulsion', 'Fortune', 'Longevity', 'Multi Shot', "Undyne's Spears", 'Brain Freeze', 'Explosion', 'Final Charge', 'HeadShot', 'Same Fate', 'Snow Storm', 'Test of Will', 'Contamination', 'Hyper Goner']
...
prices = ['Break', 'Force of Nature', 'Fridge', 'Protection', 'Tiny Froggit', 'Acceleration', 'Assault', 'Blue Snail', 'Dummy', 'Heal', 'Inflation', 'Investment', 'Penetration', 'Poison', 'Red Snail', 'Spider', 'Snowman', 'Will to Fight', 'Yellow Snail', 'Froggit', 'Moldsmal', 'Migosp', 'Loox', 'Annoying Dog', 'Bridge Seed', 'Charles', 'Defrosting', 'Ferry', 'G Follower 1', 'Lamp', 'Monster Kid', 'Pie', 'Strength', 'Temmie', 'Allergic Temmie', 'Big Bob', 'Bomb', 'Cactus', 'Candy Dish', 'Cloning', 'Crazy Bun', 'Diamond Boy 1', 'Diamond Boy 2', 'Doggo', 'Echo Flower', 'Feast', 'Fishing Rod', 'Flowey', 'Goner Kid', 'Ice Cap', 'Janitor', 'Knife', 'Mace', 'Memorial Statue', 'Microwave', 'Moldbygg', 'Napstablook', 'Punishment', 'Receptionist 3', 'Resurrection', 'Scarf Mouse', 'Shootout', 'Shopping', 'Shyren', 'Slowing', 'Soothing', 'Spider Web', 'Temmie Statue', 'Timer', 'Trash Tornado', 'Vegetoid', 'Water Cooler', 'Whimsun', 'Worsening', 'Another Chance', 'Blue Laser', 'Chilldrake', 'Clam Boy', 'Coffin', 'Disco Ball', 'Faun', 'Fire Trap', 'Froggit Trio', 'Fuku Fire', 'Glad Dummy', 'Golden Flowers', 'Heats Flamesman', 'Ice', 'Last Dream', 'Librarian', 'Memory Head', 'Mettaton', 'Migospel', 'Moldessa', 'Orange Laser', 'Parsnik', 'Politics Bear', 'Pollutant Gas', 'Receptionist 2', 'Redacted', 'Small Bird', 'Snow Poff', 'Snowdrake', 'Strafe', 'Termination', 'Tree', 'Vulkin', "Vulkin's Cloud", 'Aaron', "Aaron's Secret", 'Alphys', 'Asriel', 'Big Mouth', 'Bob', 'Brain Shift', 'Bunbun', 'Cold Winter', 'Dimensional Box', 'Dog Food', 'Dog House', 'Dogamy', 'Dogaressa', 'Echo Fish', 'Expulsion', 'Fortune', 'Garbage', 'Gaster', 'Gift Bear', 'Grillby', 'Igloo', 'Jerry', 'Longevity', 'Loren', 'MTT Fountain', 'Madjick', "Muffet's Pet", 'Multi Shot', 'Nacarat Jester', 'Pyrope', 'Red Bird', 'Skateboard Girl', 'So Sorry', 'Trader Temmie', "Undyne's Spears", 'Brain Freeze', 'Burgerpants', 'Explosion', 'G Follower 2', 'Ice Wolf', 'Innkeeper', 'Lemon Bread', 'Lesser Dog', 'Mad Dummy', 'Nice Cream Guy', 'Papyrus Statue', 'Reaper Bird', 'Receptionist 1', 'Rock', 'Sad Customer', 'Sad Dragon', 'Sans', 'Shambling Mass', 'Snail Trainer', 'Ugly Fish', 'Woshua', 'Astigmatism', 'Big Bomb', 'Bratty', 'Catty', 'Clam Girl', 'Dancer Mettaton', 'Everyman', 'Final Charge', 'Final Froggit', 'Greater Dog', 'Gyftrot', 'HeadShot', 'Manticore', 'Oni', 'Same Fate', 'Snow Storm', "Snowdrake's Mom", 'Test of Will', 'Whimsalot', 'Coffee Man', 'Contamination', 'Elder Puzzler', 'Endogeny', 'G Follower 3', 'Gerson', 'River Person', 'Tsunderplane', 'Knight Knight', 'Mettaton NEO', 'Royal Guard 1', 'Royal Guard 2', 'Glyde', 'Mettaton Ex', 'Muffet', 'Onion San', 'Toriel', 'Casual Undyne', 'Papyrus', 'Asgore', 'Frisk', 'Omega Flowey', 'Undyne', 'The Heroine', 'Asriel Dreemurr', 'Angel of Death', 'Hyper Goner', 'Chara']
costs = {'Break': 0, 'Force of Nature': 0, 'Fridge': 0, 'Protection': 0, 'Tiny Froggit': 0,
         ...
         'Froggit': 2, 'Moldsmal': 2, 'Migosp': 2, 'Loox': 2, 'Annoying Dog': 2, 'Bridge Seed': 2, 'Charles': 2, 'Defrosting': 2, 'Ferry': 2, 'Froggit': 2, 'G Follower 1': 2, 'Lamp': 2, 'Loox': 2, 'Migosp': 2, 'Moldsmal': 2, 'Monster Kid': 2, 'Pie': 2, 'Strength': 2, 'Temmie': 2,
         'Allergic Temmie': 3, 'Big Bob': 3, 'Bomb': 3, 'Cactus': 3, 'Candy Dish': 3, 'Cloning': 3, 'Crazy Bun': 3, 'Diamond Boy 1': 3, 'Diamond Boy 2': 3, 'Doggo': 3, 'Echo Flower': 3, 'Feast': 3, 'Fishing Rod': 3, 'Flowey': 3, 'Goner Kid': 3, 'Ice Cap': 3, 'Janitor': 3, 'Knife': 3, 'Mace': 3, 'Memorial Statue': 3, 'Microwave': 3, 'Moldbygg': 3, 'Napstablook': 3, 'Punishment': 3, 'Receptionist 3': 3, 'Resurrection': 3, 'Scarf Mouse': 3, 'Shootout': 3, 'Shopping': 3, 'Shyren': 3, 'Slowing': 3, 'Soothing': 3, 'Spider Web': 3, 'Temmie Statue': 3, 'Timer': 3, 'Trash Tornado': 3, 'Vegetoid': 3, 'Water Cooler': 3, 'Whimsun': 3, 'Worsening': 3,
         'Another Chance': 4, 'Blue Laser': 4, 'Chilldrake': 4, 'Clam Boy': 4, 'Coffin': 4, 'Disco Ball': 4, 'Faun': 4, 'Fire Trap': 4, 'Froggit Trio': 4, 'Fuku Fire': 4, 'Glad Dummy': 4, 'Golden Flowers': 4, 'Heats Flamesman': 4, 'Ice': 4, 'Last Dream': 4, 'Librarian': 4, 'Memory Head': 4, 'Mettaton': 4, 'Migospel': 4, 'Moldessa': 4, 'Orange Laser': 4, 'Parsnik': 4, 'Politics Bear': 4, 'Pollutant Gas': 4, 'Receptionist 2': 4, 'Redacted': 4, 'Small Bird': 4, 'Snow Poff': 4, 'Snowdrake': 4, 'Strafe': 4, 'Termination': 4, 'Tree': 4, 'Vulkin': 4, "Vulkin's Cloud": 4,
         'Aaron': 5, "Aaron's Secret": 5, 'Alphys': 5, 'Asriel': 5, 'Big Mouth': 5, 'Bob': 5, 'Brain Shift': 5, 'Bunbun': 5, 'Cold Winter': 5, 'Dimensional Box': 5, 'Dog Food': 5, 'Dog House': 5, 'Dogamy': 5, 'Dogaressa': 5, 'Echo Fish': 5, 'Expulsion': 5, 'Fortune': 5, 'Garbage': 5, 'Gaster': 5, 'Gift Bear': 5, 'Grillby': 5, 'Igloo': 5, 'Jerry': 5, 'Longevity': 5, 'Loren': 5, 'MTT Fountain': 5, 'Madjick': 5, "Muffet's Pet": 5, 'Multi Shot': 5, 'Nacarat Jester': 5, 'Pyrope': 5, 'Red Bird': 5, 'Skateboard Girl': 5, 'So Sorry': 5, 'Trader Temmie': 5, "Undyne's Spears": 5,
         'Brain Freeze': 6, 'Burgerpants': 6, 'Explosion': 6, 'G Follower 2': 6, 'Ice Wolf': 6, 'Innkeeper': 6, 'Lemon Bread': 6, 'Lesser Dog': 6, 'Mad Dummy': 6, 'Nice Cream Guy': 6, 'Papyrus Statue': 6, 'Reaper Bird': 6, 'Receptionist 1': 6, 'Rock': 6, 'Sad Customer': 6, 'Sad Dragon': 6, 'Sans': 6, 'Shambling Mass': 6, 'Snail Trainer': 6, 'Ugly Fish': 6, 'Woshua': 6,
         'Astigmatism': 7, 'Big Bomb': 7, 'Bratty': 7, 'Catty': 7, 'Clam Girl': 7, 'Dancer Mettaton': 7, 'Everyman': 7, 'Final Charge': 7, 'Final Froggit': 7, 'Greater Dog': 7, 'Gyftrot': 7, 'HeadShot': 7, 'Manticore': 7, 'Oni': 7, 'Same Fate': 7, 'Snow Storm': 7, "Snowdrake's Mom": 7, 'Test of Will': 7, 'Whimsalot': 7,
         'Coffee Man': 8, 'Contamination': 8, 'Elder Puzzler': 8, 'Endogeny': 8, 'G Follower 3': 8, 'Gerson': 8, 'River Person': 8, 'Tsunderplane': 8,
         ...
         'Asgore': 13,
         'Frisk': 14, 'Omega Flowey': 14, 'Undyne': 14,
         'The Heroine': 15,
         'Asriel Dreemurr': 18,
         'Angel of Death': 22,
         'Hyper Goner': 35,
...
arts = {"Normal": {"Copycat": "Shuffle your starting hand into your deck. Add a copy of your opponent's hand into your hand.",
                   ...
                   "Veteran": "Your monsters with 3 ATK or more gain +1 ATK when they attack and kill a monster.",
