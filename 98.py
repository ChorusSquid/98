...
classes = {"DT": ["`'Determination: Start the game with 1 extra life. When you would die, gain 15 HP instead.'`", 'Another Chance', 'Hyper Goner', 'Knife', 'Last Dream', 'Resurrection', 'Sacrifice', 'Same Fate', 'Will to Fight'],
           "PATIENCE": ["`'Patience: At the start of your turn, deal 1 damage to all paralyzed enemy monsters. If there is none, paralyze a random enemy monster.'`", 'Brain Freeze', 'Cold Winter', 'Defrosting', 'Fridge', 'Ice Replica', 'Protection', 'Sharing', 'Slowing', 'Snow Storm'],
           "BRAVERY": ["`'Bravery: At the start of your turn, draw cards until you got 4 cards into your hand.'`", "Aaron's Secret", 'Acceleration', 'Assault', 'Final Charge', 'Froggit Trio', 'Penetration', 'Rage', 'Strength'],
           "INTEGRITY": ["`'Integrity: At the end of your turn, gain 1 gold for every 5 gold spent during the turn (max 2).'`", 'Break', 'Cloning', 'Expulsion', 'Fortune', 'Golden Hit', 'Inflation', 'Investment', 'Shopping'],
           "PV": ["`'Perseverance: Whenever an enemy monster is damaged, give it KR. At the start of your opponent's turn, monsters under KR take 1 damage.'`", 'Brain Shift', 'Contamination', 'Poison', 'Pollutant Gas', 'Siphoning', 'Spider Web', 'Termination', 'Worsening'],
           "KINDNESS": ["`'Kindness: At the end of your turn, restore 2 hp to you and 1 hp to all your monsters.'`", 'Feast', 'Force of Nature', 'Heal', 'Heal Delivery', 'Longevity', 'Octofriend', 'Pie', 'Soothing', 'Test of Will'],
           "JUSTICE": ["`'Justice: At the end of your turn, deal 1 damage to a random enemy monster.\nIf you have less HP than your opponent, deal 1 bonus damage to him.'`", 'Explosion', 'Fast Sanction', 'Headshot', 'Multi Shot', 'Punishment', 'Shootout', 'Strafe', "Undyne's Spears"]}
...
arts = {"Normal": {"Copycat": "Shuffle your starting hand into your deck. Add a copy of your opponent's hand into your hand.",
                   ...
                   "Hourglass": "Your Future effects are triggered one turn earlier. At the start of the game, add a goner kid to your deck.",
                   ...
                   "Preservation": "You always overdraw the card with the lowest cost from your deck instead of the card at the top of your deck.",
                   ...
                   "Spy": "Reveal opponent's hand every 5 turns (including first). First spell revealed costs 1 more.",
        ...
        "Legendary": {"Arcane Scepter": "Whenever you cast a spell with an base cost of >= 2, cast a random spell on a random target.",
