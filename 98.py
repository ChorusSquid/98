...
costs = {'Break': 0, 'Force of Nature': 0, 'Fridge': 0, 'Protection': 0, 'Tiny Froggit': 0,
         ...
         'Astigmatism': 7, 'Big Bomb': 7, 'Bratty': 7, 'Catty': 7, 'Clam Girl': 7, 'Dancer Mettaton': 7, 'Everyman': 7, 'Final Charge': 7, 'Final Froggit': 7, 'Greater Dog': 7, 'HeadShot': 7, 'Manticore': 7, 'Oni': 7, 'Same Fate': 7, 'Snow Storm': 7, "Snowdrake's Mom": 7, 'Test of Will': 7, 'Whimsalot': 7,
         'Coffee Man': 8, 'Contamination': 8, 'Elder Puzzler': 8, 'Endogeny': 8, 'G Follower 3': 8, 'Gerson': 8, 'Gyftrot': 8, 'River Person': 8, 'Tsunderplane': 8,
