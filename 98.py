...
cards = ['Tiny Froggit',
         'Blue Snail', 'Dummy', 'Red Snail', 'Spider', 'Snowman', 'Yellow Snail',
         'Froggit', 'Moldsmal', 'Migosp', 'Loox', 'Annoying Dog', 'Bridge Seed', 'Charles', 'Ferry', 'G Follower 1', 'Lamp', 'Monster Kid', 'Temmie',
         'Allergic Temmie', 'Big Bob', 'Bomb', 'Cactus', 'Candy Dish', 'Crazy Bun', 'Diamond Boy 1', 'Diamond Boy 2', 'Doggo', 'Echo Flower', 'Fishing Rod', 'Flowey', 'Goner Kid', 'Ice Cap', 'Janitor', 'Mace', 'Memorial Statue', 'Microwave', 'Moldbygg', 'Napstablook', 'Receptionist 3', 'Scarf Mouse', 'Shyren', 'Temmie Statue', 'Timer', 'Trash Tornado', 'Vegetoid', 'Water Cooler', 'Whimsun',
         'Blue Laser', 'Chilldrake', 'Coffin', 'Disco Ball', 'Faun', 'Fire Trap', 'Fuku Fire', 'Glad Dummy', 'Golden Flowers', 'Heats Flamesman', 'Ice', 'Librarian', 'Memory Head', 'Mettaton', 'Migospel', 'Moldessa', 'Orange Laser', 'Parsnik', 'Politics Bear', 'Receptionist 2', 'Redacted', 'Small Bird', 'Snow Poff', 'Snowdrake', 'Tree', 'Vulkin', "Vulkin's Cloud",
         'Aaron', 'Alphys', 'Asriel', 'Big Mouth', 'Bob', 'Bunbun', 'Clam Boy', 'Dimensional Box', 'Dog Food', 'Dog House', 'Dogamy', 'Dogaressa', 'Echo Fish', 'Garbage', 'Gaster', 'Gift Bear', 'Grillby', 'Igloo', 'Jerry', 'Loren', 'MTT Fountain', 'Madjick', "Muffet's Pet", 'Nacarat Jester', 'Pyrope', 'Red Bird', 'Skateboard Girl', 'So Sorry', 'Trader Temmie',
         'Burgerpants', 'G Follower 2', 'Ice Wolf', 'Innkeeper', 'Lemon Bread', 'Lesser Dog', 'Mad Dummy', 'Nice Cream Guy', 'Papyrus Statue', 'Reaper Bird', 'Receptionist 1', 'Rock', 'Sad Customer', 'Sad Dragon', 'Sans', 'Shambling Mass', 'Snail Trainer', 'Ugly Fish', 'Woshua',
         'Astigmatism', 'Big Bomb', 'Bratty', 'Catty', 'Clam Girl', 'Everyman', 'Final Froggit', 'Greater Dog', 'Manticore', 'Oni', "Snowdrake's Mom", 'Whimsalot',
         'Coffee Man', 'Dancer Mettaton', 'Elder Puzzler', 'Endogeny', 'G Follower 3', 'Gerson', 'Gyftrot',  'River Person', 'Tsunderplane',
         'Knight Knight', 'Mettaton NEO', 'Royal Guard 1', 'Royal Guard 2',
         'Glyde', 'Mettaton Ex', 'Muffet',
         'Onion San', 'Toriel',
         'Casual Undyne', 'Papyrus',
         'Asgore',
         'Frisk', 'Omega Flowey', 'Undyne',
         'The Heroine',
         'Asriel Dreemurr',
         'Angel of Death',
         'Chara']
